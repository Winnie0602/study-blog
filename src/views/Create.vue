...
<form @submit.prevent="handleSubmit">
  ...
  <div>
    <input type="checkbox" v-model="tags" value="HTML">
    <span for="tags"> HTML</span>
  </div><br>
  <div>
    <input type="checkbox" v-model="tags" value="CSS">
    <span for="tags"> CSS</span>
  </div><br>
  <div>
    <input type="checkbox" v-model="tags" value="Javascript">
    <span for="tags"> Javascript</span>
  </div><br>
  <div>
    <input type="checkbox" v-model="tags" value="vue">
    <span for="tags"> Vue</span>
  </div>
  <br>
  <div>
    <input type="checkbox" v-model="tags" value="前端知識">
...
export default {
  ...
  setup(){
    ...
    const handleSubmit = async () => {
      ...
      const res = await projectFirestore.collection("posts").add(data)
